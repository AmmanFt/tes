                  ...
                  <form action="<?php echo base_url('MultiUser/Auth/register'); ?>" method="post" class="form-validate mb-4">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="radio" name="role" style="color: #fff" value="admin"> admin<br>
                        <input type="radio" name="role" style="color: #fff" value="operator"> operator<br>
                     </div>
                   <button type="submit" class="btn btn-primary"  style="color: #000" data-toggle="modal" data-target="#exampleModal" data-isi="Web Master" value="login">Register</button>
                  </form><br>
