                          ...
                          <?php echo form_open_multipart('backend/Crud/update');?>
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <?php if($u->kategori==1) echo "checked=checked";?>> Headset</input><br>
                                <input type="radio" name="kategori" value="2"
                                <?php if($u->kategori==2) echo "checked=checked";?>> Keyboard</input><br>
                                <input type="radio" name="kategori" value="3"
                                <?php if($u->kategori==3) echo "checked=checked";?>> Mouse</input><br>
                                <input type="radio" name="kategori" value="4"
                                <?php if($u->kategori==4) echo "checked=checked";?>> Mousepad</input><br><br>
                              </div>
                              <div class="form-group">
